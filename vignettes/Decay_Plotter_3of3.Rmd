...
[For steps 1-6 see _RNAdecay Vignette 1: Decay Factor Normalization of RNA-seq RPM data for Decay Modeling_ and _RNAdecay Vignette 2: Double Exponential RNA Decay Modeling_ in this package.]
...
```{r}
gene_desc = read.delim("~/gene_description_20131231.txt", quote = NULL, comment = '', header = FALSE)
...
Plot a single gene using `DecayPlot`. If you do not have a gene desription file, do not include "Desc" in the `what` argument (see `?DecayPlot`). 
```{r, fig.show = 'hold'}
